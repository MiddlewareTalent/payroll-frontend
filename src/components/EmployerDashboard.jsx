              ...
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    ...
                    {employer !== null && (<dd className="text-lg font-medium text-gray-900">{employer.totalEmployees || 0}
                      </dd>)}
                    </dl>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      {employer !== null && (<dd className="text-lg font-medium text-gray-900">{employer.totalPaySlips || 0}</dd>)}
                    </dl>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Current Tax Year</dt>
                      {employer !== null && ( <dd className="text-lg font-medium text-gray-900">{employer.currentYear || "Not Available"}</dd>)}
                    </dl>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                     ...
                     {employer !== null && (<dd className="text-lg font-medium text-gray-900">{employer.payPeriod || "Not Available"}</dd>)}
                    </dl>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    ...
                    {employer !== null && (<dd className="text-lg font-medium text-gray-900"> £ {employer.totalIncomeTax.toFixed(2)}</dd>)}   
                    </dl>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Current Year Completed Days</dt>
                      {employer !== null && ( <dd className="text-lg font-medium text-gray-900">{employer.currentYearCompletedDays || "Not Available"}</dd>)}
                    </dl>
                  </div>
                </div>
              </div>
